...
revoke all on function public.release_product_checkout(text, timestamptz) from public;
grant execute on function public.release_product_checkout(text, timestamptz) to authenticated;
revoke all on function public.release_subscription_checkout(timestamptz) from public;
grant execute on function public.release_subscription_checkout(timestamptz) to authenticated;
