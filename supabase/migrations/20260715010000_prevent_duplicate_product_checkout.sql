create table if not exists public.product_checkout_intents (
...
alter table public.product_checkout_intents enable row level security;

revoke all on table public.product_checkout_intents from anon, authenticated;
grant all on table public.product_checkout_intents to service_role;
